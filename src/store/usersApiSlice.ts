...
export const usersApiSlice = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        ...
        updateUserStatus: builder.mutation<User, { userId: string; active: boolean }>({
            query: (data) => ({
        ...
        createUser: builder.mutation<{ success: boolean; user: User; message: string }, { name: string; email: string; password: string; phone?: string; role?: number }>({
            query: (data) => ({
                url: '/users/register',
                method: 'POST',
                body: data,
