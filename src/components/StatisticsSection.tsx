...
const CountUp = ({ end, duration = 2000, index = 0 }: { end: number, duration?: number, index?: number }) => {
...
export default function StatisticsSection() {
    ...
    return (
        <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-y border-slate-800 relative overflow-hidden">
            {/* Background elements */}
