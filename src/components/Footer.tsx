                    ...
                    <div className="flex flex-col gap-6 lg:col-span-1">
                        <div className="flex items-center gap-4">
                            <div className="h-20 w-20 bg-white rounded-full flex items-center justify-center shadow-xl border-4 border-white/20 shrink-0">
                                <img loading="lazy" src="/photo_2026-03-09_14-35-44-removebg-preview.png" alt="Dept Seal" className="h-16 w-16 object-contain" />
                            </div>
                            <div className="flex flex-col">
                                <span className="text-background font-bold leading-tight tracking-tight uppercase text-sm">Immigration Department</span>
                                <span className="p-small text-primary">Ta'ang Land Government</span>
                            </div>
                        </div>
                        <p className="p-muted text-background/60 leading-relaxed">
                            The official portal for immigration services, news, and policy updates of the Ta'ang Land Government. Committed to transparency, and public service.
                        </p>
