  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'NOH Portal',
        short_name: 'NOH',
        description: 'Official portal for news, announcements and community services.',
        theme_color: '#ffffff',
      ...
      output: {
        manualChunks(id) {
          if (id.includes('node_modules')) {
            ...
            return 'libs'; // fallback for other dependencies
          }
        }
      }
    },
    // Useful for debugging chunk sizes during development
